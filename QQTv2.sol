...
contract QQT is Context, IERC20, Ownable {
    ...
    uint256 private _nextEmission = 1655568000; //emission start time have to set in production
    uint256 private _one_day   = 86400;
    uint256 private _mint_per_day = 250000000000000000000000;

    address public treasuryAddress = 0xEFb2Cd1C853699C319b6Df91308a3C76e7d41cea;
    address public crmContract ;
    address public BUSD=0x43820C266AC5E5d46e08Cd8Fe3496af0c9E703d8;
    ...
    constructor (address routerAddress) {
        ...
        emit Transfer(address(0), deadAddress, _pre_burn);
